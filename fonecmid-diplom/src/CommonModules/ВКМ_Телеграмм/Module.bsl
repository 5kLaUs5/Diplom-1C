...
Процедура ОтправитьУведомленияВТелеграмм() Экспорт
	...
	Если Не ЗначениеЗаполнено(Токен) Тогда
		...
		ЖурналРегистрации.ДобавитьСообщениеДляЖурналаРегистрации("Отправка сообщения в телеграмм. Сообщение не отправлено.", УровеньЖурналаРегистрации.Ошибка,,, "Токен для Телегамм не установлен.");
		Возврат;
	...
	Если Не ЗначениеЗаполнено(ИдентификаторЧата) Тогда
		...
		ЖурналРегистрации.ДобавитьСообщениеДляЖурналаРегистрации("Отправка сообщения в телеграмм. Сообщение не отправлено.", УровеньЖурналаРегистрации.Ошибка,,, "Идентификатор чата для Телеграмм не установлен.");
		Возврат;
