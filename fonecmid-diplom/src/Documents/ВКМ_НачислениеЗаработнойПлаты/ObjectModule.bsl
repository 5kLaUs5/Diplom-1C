...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если  ВКМ_ОсновныеНачисления.Количество() = 0 И ВКМ_ДополнительныеНачисления.Количество() = 0 Тогда
...
Процедура СформироватьДвиженияПоПремииПроцентом()	
	...
	Для Каждого ТекСтрокаДополнительныеНачисления Из ВКМ_ДополнительныеНачисления Цикл
...
Процедура СформироватьНДФЛ()
	...
	СписокСотрудников = ВКМ_ОсновныеНачисления.Выгрузить(,"Сотрудник"); 
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ВКМ_ДополнительныеНачисления,СписокСотрудников); 
...
Процедура СформироваДвиженияВыполненныеСотрудникомРаботы(Отказ)
	...
	ЭлементБлокировки.ИсточникДанных = ВКМ_ДополнительныеНачисления;
